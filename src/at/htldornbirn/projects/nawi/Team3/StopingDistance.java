...
public class StopingDistance extends BasicGameState {
    ...
    public void init(GameContainer gameContainer, StateBasedGame stateBasedGame) throws SlickException {
        ...
        brakingDistance = 0;
        font = new TrueTypeFont(new java.awt.Font("Verdana", java.awt.Font.BOLD, 15), true);
    }
    ...
    public void render(GameContainer gameContainer, StateBasedGame stateBasedGame, Graphics g) throws SlickException {
        ...
        // Anleitung ausgeben
        g.drawString("Drücke die Pfeiltasten nach oben und unten, um die Geschwindigkeit um 1 Km/h zu ändern.", 50, 520);
        g.drawString("Drücke die Pfeiltasten nach rechts und links, um die Geschwindigkeit zu ändern.", 50, 550);
        g.drawString("Drücke die R-Taste, um die Geschwindigkeit auf 0 zu setzen.", 50, 580);
