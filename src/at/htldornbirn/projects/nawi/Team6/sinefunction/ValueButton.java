...
public class ValueButton implements Actor {
    private float x, y, width, xSubtractionButton, xAdditionButton;
    ...
    public void render(Graphics graphics) {
        ...
        graphics.drawOval(xSubtractionButton, this.y, 30, 30);
        graphics.setColor(Color.green);
        graphics.drawString("+", this.x + this.width / 2 + 10, this.y + 5);
        graphics.drawOval(xAdditionButton, this.y, 30, 30);
