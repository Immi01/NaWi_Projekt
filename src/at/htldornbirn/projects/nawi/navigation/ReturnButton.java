...
public class ReturnButton implements Actor{

    private float x, y, width, height;
    private AngelCodeFont font;
    private Image image;

    public ReturnButton(float x, float y, float width, float height, Image image) throws SlickException {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public void render(Graphics graphics) {
        ...
        font.drawString(x+width/2- font.getWidth("RETURN")/2,y+height/2-20,"RETURN", Color.red);
    }
